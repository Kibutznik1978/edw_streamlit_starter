...
from .bid_line.components import (
    ...
    filters_component as bid_filters_component,
    statistics_component as bid_statistics_component,
    charts_component as bid_charts_component,
    downloads_component as bid_downloads_component,
)
...
def bid_line_analyzer_tab() -> rx.Component:
    ...
    return rx.vstack(
        ...
        # Downloads (Excel/PDF) to match Streamlit functionality
        bid_downloads_component(),
