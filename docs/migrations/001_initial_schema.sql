-- =====================================================================
-- Supabase Integration - Initial Schema Migration
-- =====================================================================
-- Version: 1.0
-- Date: 2025-10-28
...
-- - 8 core tables (bid_periods, pairings, pairing_duty_days, bid_lines,
--   profiles, pdf_export_templates, audit_log, + materialized view)
...
COMMENT ON TRIGGER on_auth_user_created ON auth.users IS 'Create profile automatically when user signs up';
...
BEGIN
  ...
  RAISE NOTICE '3. Create your first admin user (see SUPABASE_SETUP.md)';
  RAISE NOTICE '4. Test connection with test_supabase_connection.py';
  RAISE NOTICE '';
